permutation_test <- function(npermutations, dataset, seed) {
  ...
  # Gene density control - at least as many genes as Chen et al's: 265
  densitylogical <- lapply(cleanrun, nrow) > 265
  cleanrun <- cleanrun[densitylogical]
