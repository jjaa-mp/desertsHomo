...
preli1 <- read.csv(file="~/Master_CCiL_2/Interdisc/tesina/tesina_data_code/github_code/desertsHomo/1.data/median_tables/sd_Akey_Sestan.csv")
preli1 <- as_tibble(preli1) #AKEY

preli2 <- read.csv(file="~/Master_CCiL_2/Interdisc/tesina/tesina_data_code/github_code/desertsHomo/1.data/median_tables/sd_AkeyPey_Sestan.csv")
preli2 <- as_tibble(preli2) #AKEYpey

preli3 <- read.csv(file="~/Master_CCiL_2/Interdisc/tesina/tesina_data_code/github_code/desertsHomo/1.data/median_tables/sd_filtered_rawSestan.csv")
