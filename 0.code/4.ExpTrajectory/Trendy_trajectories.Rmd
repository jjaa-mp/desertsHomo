...
par(mfrow=c(3,2))
plot2 <- plotFeature(finalmdt,tVectIn = time.vector,featureNames = c("ROBO2", "ST7", "SYT6"),trendyOutData = res, customLabels.x = c("Fetal_1","Fetal_3","Child"), xlab="")
dev.off()
```
...
#Selected genes
#par(mfrow=c(3,2))
#pdf("~/MDT_GenesDesertsPosSel_ABA.pdf")
#plot2 <- plotFeature(aabb,tVectIn = time.vector,featureNames = c("ST7", "ROBO2", "CADPS2", "GPR22", "BCAP29", "KCND2", "SLC15A1"),trendyOutData = res)
#dev.off()
