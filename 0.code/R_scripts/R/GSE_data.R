GSE_data <- function (results, akeypey, out) {
  ...
  return(dfakey)
    ...
    df1subsetboth <- df1[df1$gene_short_name %in% akeypey$hgnc_symbol,]
    ...
    df1subsetboth <- df[df$gene_short_name %in% akeypey$hgnc_symbol,]
