...
#akeySestan <- from jm_Allen finalraw2 inputPC
  ...
  # brainTopStruct<-read.csv("desertsHomo/0.code/brainRegionCorresp.csv",sep=":")
  brainTopStruct<-brainTopStruct[c("Regioncode","FullReg")]
  windowPCASt=merge(brainTopStruct,windowPCA,by="Regioncode")
...
write.csv(willCoxPvals, file="~/AA_investigation/Introgression_deserts/code/new_july/PCA_PsychEncode_distances/wilcox_peynotAkeySestan.csv")
...
ggsave(supplfig_x, file="~/AA_investigation/Introgression_deserts/code/new_july/PCA_PsychEncode_distances/filtered_PeyNotAkey_supplfig.pdf", width = 11.69, height = 8.27, units = "in")
```

#AKEPEY
```{r}
akeypeySestan <- finalakeypeySestan #Input from jm_Allen or load("finalraw2_inputPC.RData")
#setwd("~/Documents/Master_CCiL_2/Interdisc/tesina/tesina_data_code/github_code")
