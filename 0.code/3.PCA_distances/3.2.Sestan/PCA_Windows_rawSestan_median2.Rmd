...
wilcox_AkeyPeySestanPC2$Structure <- paste0(wilcox_AkeyPeySestanPC2$Structure," - AkeyPey")
...
PCAPlotG<-ggplot(PCi[,1:2], aes(x=PC1, y=PC2, color=PCi$topStructure)) + 
    geom_point(size=2) + ggtitle("G)")+labs(color='Structure') + theme(legend.position = "none")#
