...
stage<- "Fetal_1" # Adult, Fetal_1, Adolescence
...
willcoxStage$Datasets<-c("Chen et al. 2020", "Chen et al. 2020 & Peyregne et al. 2017","Peyregne et al. 2017 without Chen et al. 2020","Li et al. 2018 (Whole)")
willcoxStage$log2pvalAVG<- (-1)*willcoxStage$log2pvalAVG
histogramMdt1<-ggplot(willcoxStage, aes(Datasets, log2pvalAVG, fill = Datasets)) + theme(legend.position="bottom",legend.direction = "vertical",axis.text.y=element_blank(),
  ...
  scale_fill_manual(values =   c("Chen et al. 2020" = "#7CD0FE",
                               ...
                               "Peyregne et al. 2017 without Chen et al. 2020" = "#7CFEAD",
...
graphSupp[[i]] <- ggplot(wilcoxStruct, aes(x=window, y=log2pvalAVG, group=Structure)) +
  ...
  scale_color_manual(labels = c("Chen et al. 2020", "Chen et al. 2020 & Peyregne et al. 2017","Peyregne et al. 2017 without Chen et al. 2020","Li et al. 2018 (Whole)"), values = c("blue", "red","green","brown"))+labs(color='Dataset')
}
...
#PCAPlotAkey<-PCAPlot
# wilcox_AkeySestan
wilcox_AkeyPeySestan$window <- factor(wilcox_AkeyPeySestan$window, 
    levels=c("Fetal_1","Fetal_2","Fetal_3","Birth/Inf","Inf/Child", "Child","Adolescence", "Adult"))
# subfigxAkey
subfigxAkeyPey1PC <- ggplot(wilcox_AkeyPeySestan, aes(x=window, y=log2pvalAVG, group=Structure)) +
  geom_line(aes(color=Structure))+
...
fig2_main <- grid.arrange(PCAPlot, subfigxAkeyPey1PC, histogramMdt1, 
                          layout_matrix = lay)

ggsave(file="../../../2.plots/new_vers_horizontal_fig_combined2_PCA_Fetal1_Struct_Mdt_AkeyPey_1PCAkeyPey.pdf", fig2_main, width = 20, height = 8.27, units = "in")
```