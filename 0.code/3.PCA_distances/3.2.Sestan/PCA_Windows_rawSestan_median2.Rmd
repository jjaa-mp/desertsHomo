...
fig2_main <- grid.arrange(PCAPlot, subfigxAkeyPey, histogramMdt, 
                          layout_matrix = lay)

ggsave(file="../../../2.plots/new_vers_horizontal_fig_combined2_PCA_Fetal1_Struct_Mdt_AkeyPey.pdf", fig2_main, width = 20, height = 8.27, units = "in")
```