...
ggsave(supplfig_x, file="~/AA_investigation/Introgression_deserts/code/new_july/JS_PCA_Sestan_distances/filtered_Whole_supplfig.pdf", width = 11.69, height = 8.27, units = "in")
